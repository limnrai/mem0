#!/usr/bin/env python3
"""
Test script to verify input token counting in AsyncMemory.add() function.
...
async def test_async_token_counting():
    """Test that token counting is working in the AsyncMemory.add() function."""
    
    print("Testing input token counting in AsyncMemory.add()...")
    print("-" * 60)
...
if __name__ == "__main__":
    asyncio.run(test_async_token_counting())
